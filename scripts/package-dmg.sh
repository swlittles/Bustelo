...
"$TOOLS/bin/dmgbuild" -s scripts/dmg-settings.py -D app="$APP" -D background="$ART/background.tiff" Bustelo "$DESTINATION"
...
codesign --verify --deep --strict "$MOUNT/Bustelo.app"
